...
import particalTexture1 from "./Assets/image/Particals/star_04.png";
import showTexture1 from "./Assets/image/Particals/magic_04.png";
import doctorCloud1Texture from "./Assets/image/cloud1.png";
import doctorCloud2Texture from "./Assets/image/cloud2.png";
import doctorCloud3Texture from "./Assets/image/cloud3.png";
import doctorCloud4Texture from "./Assets/image/cloud4.png";
...
const doctorCloud1TextureT = new THREE.TextureLoader().load(doctorCloud1Texture);
const doctorCloud2TextureT = new THREE.TextureLoader().load(doctorCloud2Texture);
const doctorCloud3TextureT = new THREE.TextureLoader().load(doctorCloud3Texture);
const doctorCloud4TextureT = new THREE.TextureLoader().load(doctorCloud4Texture);
...
for (let i = 0; i < 200; i++) {
  ...
  const snow = new THREE.Mesh(new THREE.PlaneGeometry(0.015, 0.015), snow1Material);
  if(randomX >=0.2 || randomX <= -0.2  ){
...
for (let i = 0; i < 50; i++) {
  ...
  const shine = new THREE.Mesh(new THREE.PlaneGeometry(0.03, 0.03), shine1Material);
  if(randomX >=0.2 || randomX <= -0.2  ){
...
function loadNextImage(loader) {
  ...
  if (index > 3) {
    ...
    next.onclick = function (e) {
      ...
      const x = e.clientX - container.offsetLeft - imageContainer.offsetWidth / 2;
      const y = e.clientY - container.offsetTop - imageContainer.offsetHeight / 2;
